...
<head>
	<title>Ayushman Blood Bank | Home Page</title>
...
Type O individuals are often called "universal donors" since their blood can be transfused into persons with any blood type. Those with type AB blood are called "universal recipients" because they can receive blood of any type.</p>
            ...
            <div class="col-md-4" style="padding-top: 30px;"> 
                ...
                <!-- <a class="btn btn-lg btn-secondary btn-block login-button ml-lg-5 mt-lg-0 mt-4 mb-lg-0 mb-3" data-toggle="modal" data-target="#exampleModalCenter1" href="sign-up.php" data-toggle="modal" data-target="#exampleModalCenter1"> Become a Donar</a> -->
				 <a  href="sign-up.php" class="btn btn-lg btn-secondary btn-block login-button ml-lg-5 mt-lg-0 mt-4 mb-lg-0 mb-3" > Become a Donar</a>
            </div>
        </div>
		</div>
	</div>
